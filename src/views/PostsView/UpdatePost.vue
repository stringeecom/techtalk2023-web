    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title"><strong>Update Post</strong></h3>
        </div>
        <div class="card-body">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group cat_page_div">
                ...
                <input ref="title" type="text" class="form-control square" v-model="input.title"
                       placeholder="Tiêu đề">
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-6">
              <div class="form-group cat_page_div">
                <label for="eventRegInput1">Thumbnail <span
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group cat_page_div">
                <label>Link thumb <span
                  class="required_t icon_t">*</span></label>
                <input :disabled="disable_thumb_input" @change="onLinkThumbChange()" v-model="input.thumb"
                       type="text" ref="thumb" placeholder="Thumb Link"
                       class="form-control" />
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group cat_page_div">
                ...
                <textarea ref="metaKeywords" rows="3" class="form-control square"
                          v-model="input.metaKeywords"></textarea>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group cat_page_div">
                ...
                <textarea ref="description" rows="3" class="form-control square"
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group cat_page_div">
                ...
                <textarea :id="idMCE" rows="10" class="form-control square"
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group cat_page_div">
                <button @click.prevent="onUpdateClicked()" class="btn btn-success">Update</button>
              </div>
            </div>
...
<!--      <SelectImage :open="show_select_image"-->
<!--                   :tinyWin="tinyWin"-->
<!--                   :type_select_image="type_select_image"-->
<!--                   :onCancel="onSelectImageCancelled"-->
<!--                   :callbackFn="onUploaded" />-->
    </div>
  </section>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.loadCategories();
    const id = m_utils.getParameterByName("id");
    this.loadInfo(id);
  },
  ...
  methods: {
    ...
    loadInfo(id) {
      api.get(this, "/post/find-one", { id: id }, (data) => {
        ...
        if (data.data.rc === 0) {
          ...
          if (item !== undefined && item !== null) {
            ...
            if (categories !== undefined && categories.length > 0) {
              this.input.category = categories[0].id;
            }

            this.input.thumb = item.thumb;
            this.thumb_check = true;
            this.onLinkThumbChange();

            this.input.metaKeywords = item.keywords;
            this.thumb_type = "1";
            console.log(JSON.stringify(item));
            this.plugin_editor(`#${this.idMCE}`, { append_plugins: "image  media code", height: 500 }, item.content);
          }
        }
    ...
    onUpdateClicked() {
      ...
      dialog.confirmDialog("Do you want update this post", "Update", () => {
        api.post(this, "/post/update", params, (data) => {
          console.log("data: " + JSON.stringify(data.data));
          let rc = parseInt(data.data.rc);
          let mResp = m_utils.getMessageResponse2(data, "Update post success !", "Update post failed !");
          if (rc === 0) {
    ...
    plugin_editor(selector, settings, initContent) {
